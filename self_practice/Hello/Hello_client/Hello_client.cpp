// Hello_client.cpp : 콘솔 응용 프로그램에 대한 진입점을 정의합니다.
// client
...
int main(int argc, char* argv[])
{
	...
	//	receive message from server with hSocket and save return parameter at strLen. If return parameter is '-1', call ErrorHandling
